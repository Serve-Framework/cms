...
[
     ...
     * password      : Encrypted password to use for SMTP authentication (using $serve->Crypto->encrypt('foo'))
     ...
     *
     */
    'log_dir' => SERVE_APPLICATION_PATH . '/storage/emails',
    ...
    [
        ...
        'logo_url'        => isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && $_SERVER['HTTPS'] != 'off' ? 'https://' . $_SERVER['HTTP_HOST'] . '/app/public/uploads/serve-logo.png' : 'http://' . $_SERVER['HTTP_HOST'] . '/app/public/uploads/serve-logo.png',
        'font_size_h1'    => '30px',
        'font_size_h2'    => '28px',
        'font_size_h3'    => '24px',
        'font_size_h4'    => '20px',
