...
class CommentManager extends Manager
{
     ...
     * SPAM protector.
     *
     * @var \serve\security\spam\SpamProtector
     */
     ...
     * @param \cms\wrappers\providers\CommentProvider $provider      Comment provider
     * @param \serve\security\spam\SpamProtector  $spamProtector SPAM protector
     * @param \serve\config\Config                $config        Framework config
     * @param \serve\http\request\Environment     $environment   HTTP request env
     */
    public function __construct(Builder $SQL, CommentProvider $provider, SpamProtector $spamProtector, Config $config, Environment $environment)
    {
        $this->SQL = $SQL;
