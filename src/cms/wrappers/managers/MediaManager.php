...
class MediaManager extends Manager
{
     ...
     * @param \cms\wrappers\providers\MediaProvider $provider       Provider manager
     * @param \serve\http\request\Environment   $environment    Request environment
     * @param \serve\auth\Gatekeeper                  $gatekeeper     Gatekeeper instance
     * @param \serve\pixl\Image                 $pixl           Pixl Instance
