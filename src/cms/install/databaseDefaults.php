...
$hashed = Application::instance()->Crypto->password()->hash($this->config->get('cms.default_password'));

// Default articles table
$SERVE_DEFAULTS_POSTS_TABLE =
[
...
$SERVE_DEFAULTS_POST_META_TABLE =
[
	'id' 	   => 'INTEGER | UNSIGNED | PRIMARY KEY | UNIQUE | AUTO INCREMENT',
	'content'  => 'TEXT',
...
$SERVE_DEFAULTS_CATEGORIES_TABLE =
[
	'id'          => 'INTEGER | UNSIGNED | PRIMARY KEY | UNIQUE | AUTO INCREMENT',
	'name'        => 'VARCHAR(255)',
	'slug'        => 'VARCHAR(255)',
...
$SERVE_DEFAULTS_TAGS_TO_POSTS_TABLE =
[
	'id' 	  => 'INTEGER | UNSIGNED | PRIMARY KEY | UNIQUE | AUTO INCREMENT',
...
// Default tags to posts table
$SERVE_DEFAULTS_CATEGORIES_TO_POSTS_TABLE =
[
	'id' 	      => 'INTEGER | UNSIGNED | PRIMARY KEY | UNIQUE | AUTO INCREMENT',
...
$SERVE_DEFAULTS_CONTENT_TO_POSTS_TABLE =
[
	'id' 	   => 'INTEGER | UNSIGNED | PRIMARY KEY | UNIQUE | AUTO INCREMENT',
	'content'  => 'TEXT',
	'post_id'  => 'INTEGER | UNSIGNED',
...
[
	[
		...
		'title'       => 'Hello World!',
		'excerpt'     => 'Welcome to Serve. This is your first post. Edit or delete it, then start blogging!',
		'author_id'   => 1,
		'thumbnail_id'   => 2,
	...
	[
		...
		'status'      => 'published',
		'type'        => 'post',
		'slug'        => 'html/markdown-basics/',
		'title'       => 'Markdown Basics',
		'excerpt'     => 'This is intended as a quick reference and showcase. Serve uses Markdown Extra to parse article content. Content written within the Serve Writer application is stored in the database as raw text. When the article content is loaded, it is parsed using ParseDown Extra.',
		'author_id'   => 1,
		'thumbnail_id'     => 3,
		'comments_enabled' => true,
	],
...
[
	...
	file_get_contents(__DIR__ . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'LorumIpsum.md'),
];
...
$SERVE_DEFAULT_PAGE_CONTENT =
[
	file_get_contents(__DIR__ . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'MarkdownBasics.md')
];

// The default comments entries
$SERVE_DEFAULT_COMMENTS =
[
	[
		'post_id'      => 1,
