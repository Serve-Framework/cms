		...
		<div class="interstitial-wrapper">
			<div class="content">
				...
				<div class="body-copy row">
					<p>By <?php echo $serve->Config->get('cms.route_authors') ? '<a title="View All Posts By ' . the_author_name() . '" href="' . the_author_url() . '">' . the_author_name() . '</a>' : the_author_name(); ?> on <time datetime="<?php echo the_time('c'); ?>"><?php echo the_time('l, F d, Y \a\t h:ia'); ?></time></p>
					<p>
					...
					<dl class="dl-horizontal">
						...
						<dt>File Name:</dt>
					    <dd><?php echo Str::getAfterLastChar(trim($serve->Request->environment()->REQUEST_URL, '/'), '/'); ?></dd>
					    ...
					    <dd>
					    	...
					    	&nbsp;•&nbsp;
					    	<?php
					    	$sizes = array_reverse($serve->Config->get('cms.uploads.thumbnail_sizes'));
