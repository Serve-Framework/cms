...
class Categories extends BaseModel
{
     ...
     * @return array|false
     */
    private function parsePost(): array|false
    {
       ...
       // Get queries
        ...
        if ($rows)
        {
            foreach ($rows as $row)
            {
                ...
                $category->article_count = !$count ? 0 : count($count);
     ...
     *
     * @param  \cms\wrappers\Category $parent   Category parent object
