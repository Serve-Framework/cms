			...
			<div class="card">
			    <div class="card-header">
			    	<span class="color-gray">
			    		<?php echo $visitor->name; ?> Visited <a class="text-ellipses" style="max-width: 300px;display: inline-block;vertical-align: top;" href="<?php echo $visit->page; ?>"><?php echo str_replace($serve->Request->environment()->HTTP_HOST, '', $visit->page); ?></a>
