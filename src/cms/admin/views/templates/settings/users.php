...
<div class="col-12 col-md-8 roof-sm floor-sm">
	...
	<p class="color-gray">
		By default, signing up as an author to Serve is barred for security reasons. However you can add other users
		by inviting them here. Serve will send them an email with a special url to register.
	</p>
