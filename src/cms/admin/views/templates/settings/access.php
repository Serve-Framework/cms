<?php
    $enable_robots  = $serve->Config->get('cms.security.enable_robots');
    $robots_content = $serve->Config->get('cms.security.robots_text_content');

    $enable_ip_block = $serve->Config->get('cms.security.ip_blocked');
    $ip_whitelist    = $serve->Config->get('cms.security.ip_whitelist');
?>
