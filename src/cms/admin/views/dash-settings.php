...
<div class="dash-wrap js-dash-wrap">
	...
	<ul class="tab-nav tab-border">
	    ...
	    <li><a href="/admin/settings/serve/"     <?php if ($active_tab === 'serve') echo 'class="active"'; ?>>Serve</a></li>
	...
	<?php elseif ($active_tab === 'serve') : ?>
		<!-- KANSO -->
		<?php require_once($_TEMPLATES_DIR . DIRECTORY_SEPARATOR . 'settings' . DIRECTORY_SEPARATOR . 'serve.php'); ?>
