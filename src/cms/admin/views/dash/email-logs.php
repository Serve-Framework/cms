...
<div class="dash-wrap js-dash-wrap">
	...
	<section class="items-list roof-xs">
		...
		<!-- LIST POWERS -->
		<?php include dirname(__DIR__) . '/templates/logs/emails/list-powers.php'; ?>

		<!-- LIST BODY -->
		<?php include dirname(__DIR__) . '/templates/logs/emails/list-body.php'; ?>

		<!-- LIST FOOTER -->
		<?php include dirname(__DIR__) . '/templates/logs/emails/list-pagination.php'; ?>
